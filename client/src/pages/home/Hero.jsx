      ...
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <button className="btn btn-lg btn-filled" onClick={() => navigate("/signup")}>Get Started</button>
            <button className="btn btn-lg btn-text" onClick={() => navigate("/about")}>Learn More ↓</button>
          </div>
